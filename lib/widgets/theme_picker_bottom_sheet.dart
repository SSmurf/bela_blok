          ...
          GridView.count(
            ...
            children: [
              ...
              _buildColorPaletteItem(
                ...
                title: loc.translate('spring'),
                primaryColor: SeasonalThemes.spring(Brightness.light).primary,
                secondaryColor: SeasonalThemes.spring(Brightness.light).secondary,
                accentColor: SeasonalThemes.spring(Brightness.light).tertiary,
                height: gridItemHeight,
                isSmallScreen: isSmallScreen,
              ),
              _buildColorPaletteItem(
                palette: ColorPalette.summer,
                title: loc.translate('summer'),
                primaryColor: SeasonalThemes.summer(Brightness.light).primary,
                secondaryColor: SeasonalThemes.summer(Brightness.light).secondary,
                accentColor: SeasonalThemes.summer(Brightness.light).tertiary,
                height: gridItemHeight,
                isSmallScreen: isSmallScreen,
              ),
              _buildColorPaletteItem(
                palette: ColorPalette.autumn,
                title: loc.translate('autumn'),
                primaryColor: SeasonalThemes.autumn(Brightness.light).primary,
                secondaryColor: SeasonalThemes.autumn(Brightness.light).secondary,
                accentColor: SeasonalThemes.autumn(Brightness.light).tertiary,
                height: gridItemHeight,
                isSmallScreen: isSmallScreen,
              ),
              _buildColorPaletteItem(
                palette: ColorPalette.winter,
                title: loc.translate('winter'),
                primaryColor: SeasonalThemes.winter(Brightness.light).primary,
                secondaryColor: SeasonalThemes.winter(Brightness.light).secondary,
                accentColor: SeasonalThemes.winter(Brightness.light).tertiary,
                height: gridItemHeight,
                isSmallScreen: isSmallScreen,
              ),
            ],
